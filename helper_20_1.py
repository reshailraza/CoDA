...
exp_data = loadmat('landseed_processed__new_data.mat', squeeze_me=True)
...
add_training_dataset('training_20', 'samples_1.22.mat', 'param_samples_1.22.mat', 'iterative_results_5001.mat')
# add_training_dataset('training_16', 'samples_16.mat', 'param_samples.mat', 'iterative_results_16.mat')
# add_training_dataset('training_20_16x15', 'samples_20.mat', 'param_samples_20.mat', 'iterative_results_20.mat')
# add_training_dataset('training_16_16x15', 'samples_16.mat', 'param_samples.mat', 'iterative_results_16.mat')
...
x, y = np.meshgrid(np.arange(mask_width), np.arange(mask_height))

# Calculate the distances from the center of the mask
distances = np.sqrt((x - center_x) ** 2 + (y - center_y) ** 2)

# Define the radius of the ellipse
ellipse_radius_x = mask_width // 2
ellipse_radius_y = round(ellipse_radius_x / 1.22)
#ellipse_radius_y = round(ellipse_radius_x / 1.15)
#ellipse_radius_y = round(ellipse_radius_x / 1.21)
#ellipse_radius_y = round(ellipse_radius_x / 1.06)
#ellipse_radius_y = round(ellipse_radius_x / 1.0)
mask = (distances <= ellipse_radius_x) & ((y - center_y) ** 2 / ellipse_radius_y ** 2 + (x - center_x) ** 2 / ellipse_radius_x ** 2 <= 1)
